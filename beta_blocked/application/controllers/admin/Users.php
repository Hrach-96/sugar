...
class Users extends CI_Controller {
	...
	public function index() {
        ...
        $data["users"] = $this->user_model->get_all_users_list($per_page, $offset, $search_key, $search_gender, $search_online, $search_country, $search_vip);
        ...
        $total_users = $this->user_model->count_all_users($search_key, $search_gender, $search_online, $search_country, $search_vip);
