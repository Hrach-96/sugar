...
<tr>
	...
	<img style="width:128px;height:128px;border-radius:50%;object-fit:cover;border: 1px solid #464646;" src="<?php echo $message_sender_pic; ?>" />
	</td>
	<td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 15px 15px ;vertical-align: top;" align="left">
		<h4 style="text-transform: uppercase;padding: 0px 0px;margin: 0px;font-size: 20px;color: rgb(232, 228, 151);font-family: 'Cinzel', serif;font-weight: 500;"><?php echo $this->lang->line('hello').' '.$message_receiver_name; ?>,</h4>
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $message_sender_name.' '.$this->lang->line('asked_you_a_question'); ?>.</h4>
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('log_in_directly_and_answer_the_question_of').' '.$message_sender_name; ?>!</h4>
