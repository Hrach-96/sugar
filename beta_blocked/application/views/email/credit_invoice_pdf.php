...
<h4 style="padding: 0px 0px;margin: 0px;font-size: 14.67px;color: #000;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_fourth_text'); ?> &euro;<?php echo $purchase_amount.' '.$this->lang->line('credits_purchased_email_template_fifth_text'); ?></h4>
