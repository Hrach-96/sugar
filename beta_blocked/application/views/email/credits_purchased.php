...
<tr>
	...
	<td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 15px 15px ;vertical-align: top;" align="left">
		...
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_first_text'); ?></h4>
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_second_text').' '.$purchased_credits.' '.$this->lang->line('credits_purchased_email_template_third_text'); ?></h4>
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_fourth_text'); ?> &euro;<?php echo $purchase_amount.' '.$this->lang->line('credits_purchased_email_template_fifth_text'); ?></h4>
	</td>
</tr>
<tr>
	...
	<td class="hero-subheader__title" style="font-size: 43px;font-weight: bold;padding: 0px 15px;vertical-align: middle;" align="left">	
		...
		<br/>
		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_sixth_text'); ?></h4>
