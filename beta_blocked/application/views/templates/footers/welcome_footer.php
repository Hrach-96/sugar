	...
	<div class="modal fade transparent_mdl landing-page-bg" id="welcomeAdsModal" role="dialog" style="z-index: 1000;">
	    <div class="modal-dialog">
	      	<!-- Modal content-->
	      	<div class="modal-content welcome-modal-content">
	        	...
	        	<div class="modal-body wel-ads-mod-body" style="">
	        		<div class="wel-adss-inner-box">
		          		<h4 class="full-pay gold-txt text-center"><span class="sign_span countdown-text"><?php echo $this->lang->line('countdown'); ?></span></h4>
						...
						<div class="modal-logo-main-div">
							<img src="<?php echo base_url('images/sugarbabe-logo.png'); ?>" class="modal-logo-image">
						</div>
    ...
    <script src="<?php echo base_url(); ?>js/pages/welcome_ok.js?ver=1"></script>
