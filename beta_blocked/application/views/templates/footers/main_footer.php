	...
	<footer>
		<div class="row">
			...
			<div class="col-md-5 col-sm-5 sm3 social_links hiddenSL">
				...
				<img src="<?php echo base_url('images/ios.png'); ?>" class="ios">
				<img src="<?php echo base_url('images/android.png'); ?>" class="android">
		...
		<div class="copyright">
			...
			<div class="col-md-5 col-sm-4 text-right">
				<div class="amazon-div">
					<img src="<?php echo base_url('images/256-amazon.png'); ?>" class="256-amazon">
				</div>
			</div>
		</div>
	</footer>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 text-center">
						...
						<a href="<?php echo base_url('user/profile/edit'); ?>" class="go_online_shop Rettangolo_2 btn_hover" id="buy_nw_credits"><?php echo $this->lang->line('upload_your_profile_picture_now'); ?>
						...
						<a href="#" data-dismiss="modal" class="go_online_shop Rettangolo_2 btn_hover btnspater" id="buy_nw_credits"><?php echo $this->lang->line('later'); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<script src="<?php echo base_url(); ?>js/pages/pages.js"></script>
<script src="<?php echo base_url(); ?>js/pages/online.js"></script>
...
<script src="<?php echo base_url(); ?>js/pages/chatroom.js"></script>
<?php endif; ?>
