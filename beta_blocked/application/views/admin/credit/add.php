...
<div class="col-lg-12 block_form">	
	<form action="" method="post" accept-charset="utf-8" class="general_config well">
	    ...
	    <fieldset>
	        ...
	        <div class="form-group">
	            <label for="package_credits"><?php echo $this->lang->line('package_credits'); ?> :</label>
	            <input type="text" class="form-control" id="package_credits" name="package_credits" value="<?php echo set_value("package_credits"); ?>" placeholder="e.g. 10">
	            <?php echo form_error('package_credits'); ?>
	        </div>	        
	        <div class="form-group">
	            <label for="package_amount"><?php echo $this->lang->line('package_amount'); ?> :</label>
	            <input type="text" class="form-control" id="package_amount" name="package_amount" value="<?php echo set_value("package_amount"); ?>" placeholder="e.g. 100.00">
