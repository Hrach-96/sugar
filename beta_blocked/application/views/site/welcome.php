		...
		<div class="container">
			...
			<div class="row wlcm_rw">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="sugarbabe_logo">
						<img src="<?php echo base_url('images/Sfondo-copia.png'); ?>" class="sugarbabe_back">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-xs-12 text-right">
					<div class="wlcm_bx">
						<img src="<?php echo base_url('images/sugarbabe-logo.png'); ?>" class="sugarbabe_logo_home" alt="Sugarbabe"><br/><br/>
						...
						<a href="<?php echo $this->facebook->login_url();?>" class="continue_btn next member_login register_btn fb_i" ><span class="cont_span"><img src="images/fb_icon.png"><?php echo $this->lang->line('login_with_facebook'); ?></span></a>
						...
						<a href="#"><img src="<?php echo base_url('images/home-amazon-256.png'); ?>" class="home-amazon-256" alt="Sugarbabe"></a>
						<br/><br/>
					</div>
				</div>
				<div class="col-md-1"></div>
			...
			<div class="row scrll_rw">
				<div class="col-md-12 text-center">
					<a href="#2"><img src="<?php echo base_url('images/scroll_icon.png'); ?>"></a>
				</div>
			</div>
		</div>
	</header>
        		...
        		<div class="col-md-12 text-center">
            		<div id="testimonial-slider" class="owl-carousel">
		                ...
		                <div class="testimonial">
		                    <div class="pic">
		                        <img src="<?php echo base_url('images/testimonials/sabine_r.png'); ?>" alt="">
		                    </div>
							<ul class="rating">
						...
						<div class="testimonial">
		                    <div class="pic">
		                        <img src="<?php echo base_url('images/testimonials/mario_l.png'); ?>" alt="">
		                    </div>
							<ul class="rating">
		                        <li class="fa fa-star gold-star"></li>
		                        <li class="fa fa-star gold-star"></li>
						...
						<div class="testimonial">
		                    <div class="pic">
		                        <img src="<?php echo base_url('images/testimonials/nicole_g.png'); ?>" alt="">
		                    </div>
							<ul class="rating">
		                        <li class="fa fa-star gold-star"></li>
		                        <li class="fa fa-star gold-star"></li>
					...
					<div class="selection_div">
						...
						<!-- div class="row">	
							...
							<div class="col-md-12 text-center">
								...
								<a href="#" class="fb_btn"><img src="images/fb_icon.png"><?php echo $this->lang->line('facebook_connect'); ?></a>
							</div>
						</div -->
					</div>
      			</div>
 	...
 	<div class="modal-dialog">
    	...
    	<div class="modal-content">
	  		...
	  		<div class="none third">
				...
				<h3 class="register_title"><?php echo $this->lang->line('join_us_txt'); ?></h3>
				<div class="text-left email_box">
					<label><img id="captcha_image_url" src="<?php echo $captcha_image_url; ?>" style="width:100%;height:45px;" /></label>
