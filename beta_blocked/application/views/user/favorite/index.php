...
<!--favorite section-->
<section class="question_section kisses_section">		
	<div class="container">
        ...
        <div class="col-md-12">
			...
			<div class="row chat_btns">	
			     <div class="col-md-12">
					<h4 class="full-pay gold-txt">
			          <span class="byDiamonds"><?php echo $this->lang->line('favorite'); ?>
					  </span>
			        </h4>
				</div> 
			</div>            	
			<div class="row">	
				...
				<li class="col-md-6"><a href="<?php echo base_url('favorites?type=by_me'); ?>" rel="div1" class="showSingle qbtn <?php if($favorite_type == 'by_me') { echo 'active-tab'; } ?>"><?php echo $this->lang->line('favorite_by_me'); ?></a></li>
				<li class="col-md-6"><a href="<?php echo base_url('favorites?type=to_me'); ?>" rel="div1" class="showSingle qbtn <?php if($favorite_type == 'to_me') { echo 'active-tab'; } ?>"><?php echo $this->lang->line('favorite_to_me'); ?></a></li>
                </ul>
				</div>
                <div class="question_bx">                	
				<div class="favorite_div qusn_rw">	
					<div class="kisses_div">
		<div class="row">
			<?php 
				if($favorite_type == 'by_me' || ($favorite_type == 'to_me' && $this->session->userdata('user_is_vip') == 'yes')) {			
					if(!empty($users)) {
			...
			<div class="col-xs-6 col-sm-6 col-md-3">
				<div class="profile_thumbnail profile_data" rel="<?php echo $user_row['user_id_encrypted']; ?>">
					<a href="<?php echo base_url('user/profile/view?query=').urlencode($user_row['user_id_encrypted']); ?>" class="profile_a">
						<img src="<?php echo base_url().$user_row['user_active_photo_thumb']; ?>" alt="">
					</a>
					<div class="caption">
					  	<div class="row">
					  		<div class="col-md-6-12 col-sm-12 col-xs-12">
...
<!-- 							<div class="col-md-12 col-sm-12 col-xs-12">
								<h4 class="text-right" style="font-size: 10px;"><?php echo date('d M Y', strtotime($user_row['kiss_added_date'])); ?></h4>		
							</div>					 -->
						</div>		
						<hr class="pro_hr" />
						<div class="row">
