			...
			<div class="col-md-7">
				<div id="example5" class="slider-pro">
					...
					<?php 						
						...
						?>
						<div class="sp-slide">
							<img style="background-repeat: no-repeat;background-size: 100% 100%;" data-id="<?php echo $photo_row['photo_id']; ?>" class="sp-image" 
							...
							<div style="position: absolute;left: 0px;top: 0px;height: 100%;width: 100%;background-color: #0009;">
								<center>
									...
									<br>
									<h3 class="text-center"><?php echo $this->lang->line('only_visible_to_vip_members'); ?></h3>
									<br>
							...
							<div style="position: absolute;left: 0px;top: 0px;height: 100%;width: 100%;background-color: #0009;">
								<center>
									<br><br><br><br>
									<img src="<?php echo base_url('images/unlock_user_photo_screen_thumb.png'); ?>" style="width: 56px;">
									<br>
									<h3 class="text-center"><?php echo $this->lang->line('send_image_unlock_request_to_this_user'); ?></h3>
									<br>
					...
					<?php 
						...
						<div class="sp-thumbnail">
							<div class="sp-thumbnail-image-container">
								...
								<img class="sp-thumbnail-image" src="<?php echo $back_image_url; ?>"/>
...
<!-- 						<li class="ad_dmdns">
    		...
    		<div class="col-md-5">
				...
				<div class="report_user pull-right">
					<span style="margin-right: 20px;"><i class="fa fa-thumbs-down fa-2x  <?php echo ($is_disliked) ? 'active-icon-red':'btn-user-dislike'; ?>"></i></span>
