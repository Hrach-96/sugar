$(document).ready(function() {
	...
	// Validations for register page
   	$('#registerModal .next').on('click', function() {
		...
		if(currStep == 'eight') {
			...
			var locality = $("#registerModal input[name=locality]").val();			
			var isNumberPat = /^[0-9]*$/;
	...
	$(".btn-register").click(function(e) {
		...
		var user_postcode = $("#registerModal input[name=user_postcode]").val();
		var locality = $("#registerModal input[name=locality]").val();
		var user_country = $("#registerModal input[name=country]").val();
		var user_latitude = $("#registerModal input[name=user_latitude]").val();
		var user_longitude = $("#registerModal input[name=user_longitude]").val();
