		...
		<div class="row">
			<form class="contact_form" method="POST" action="" enctype="multipart/form-data">
				<div class="col-md-4 col-sm-4 padding_zero rel">
					<img src="<?php echo base_url('images/contact-back1.png'); ?>" alt="<?php echo $this->lang->line('white_paper_airplane') ?>" class="contact_back abs" />
					<img src="<?php echo base_url('images/contact-back-small.png'); ?>" alt="<?php echo $this->lang->line('white_paper_airplane') ?>" class="contact_back1 abs" />
				</div>
