...
<head>
	...
	<?php
		if($this->uri->uri_string() == 'page/cancellation_terms' || $this->uri->uri_string() == 'page/privacy_statement' || $this->uri->uri_string() == 'page/terms_of_use' || $this->uri->uri_string() == 'page/contactUs' || $this->uri->uri_string() == 'page/faq' || $this->uri->uri_string() == 'page/imprint' ){
			?>
    ...
    <link href="<?php echo base_url(); ?>css/site/style.css?v=1.0" rel="stylesheet">
				...
				<div class="col-md-6 col-sm-6 col-xs-3">
					<div class="logo_div">
						<a href="<?php echo base_url('home'); ?>">
							<img src="<?php echo base_url(); ?>images/logo.png" alt="<?php echo $this->lang->line('sugarbabe_deluxe_logo') ?>">
						</a>
					</div>
				</div>
