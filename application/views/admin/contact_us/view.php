...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong><?php echo $this->lang->line('contact_us'); ?></strong>
            </li>
        </ol>
    </div>
</div>
    ...
    <div class="ibox-content-no-bg">
	    ...
	    <?php
			...
			<tr>
				...
				<td style='white-space: initial;'><?php echo $message['message']; ?></td>				
				<td><?php echo convert_date_to_local($message['message_date'], SITE_DATETIME_FORMAT); ?></td>
				...
				<td><?php echo $message['message_reply_text']; ?></td>	
				<td style='text-align:center'>
					<a href="<?php echo base_url('admin/contactUs/reply/'.$message['contact_us_id']); ?>"><i class="fa fa-reply"></i> <?php echo $this->lang->line('reply'); ?></a>
					<a href="<?php echo base_url('admin/contactUs/archive/'.$message['contact_us_id']); ?>" class='text-danger'><i class="fa fa-remove"></i><br> <?php echo $this->lang->line('delete'); ?></a>
				</td>
			</tr>	    	
			<?php
				endforeach;
