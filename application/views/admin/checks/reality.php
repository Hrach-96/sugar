...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-7">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong><?php echo ucfirst($this->lang->line('reality_check')); ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-5">
	    <form class="form-inline" method="GET" action="<?php echo base_url('admin/checks/reality'); ?>">
			...
			<tr data-id="<?php echo $approval['document_id']; ?>">
				...
				<td class="userAction">
					<?php if($approval['document_status'] == 'pending') { 
						...
						<button data-id = 'verified' class="btn btn-success btn-sm btn-block btn-verify-reality-document" style="padding: 2px 15px;"><?php echo $this->lang->line('verify'); ?></button>					
						<button data-id = 'rejected' class="btn btn-danger btn-sm btn-block btn-verify-reality-document" style="padding: 2px 15px;"><?php echo $this->lang->line('reject'); ?></button>
					<?php } else { ?>
						<button data-id = 'deleted' class="btn btn-danger btn-sm btn-block btn-verify-reality-document" style="padding: 2px 15px;"><?php echo $this->lang->line('delete'); ?></button>
					<?php } } ?>
				</td>
			</tr>	    	
			<?php
