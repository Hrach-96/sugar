...
<div class="col-lg-12 block_form">
	<form action="/admin/gift/canceled" accept-charset="utf-8" >
		<div class='col-md-4'>
...
<div class="col-lg-12">
	<div class="clearfix clearfix_mobile_class">
	    ...
	    <?php
	    		$sr_no = 1;
	    		foreach($canceled_user_list as $user):
			?>
				<tr>
					...
					<td><?php echo convert_date_to_local($user['canceled_date'], SITE_DATETIME_FORMAT); ?></td>
				</tr>
			<?php
				endforeach;
			endif;
	    ...
	    ?>
			<table class="table table-striped table-hover gift_table_custom_class">
				<thead>
					...
					<th><?php echo $this->lang->line('user_credits'); ?></th>
					<th><?php echo $this->lang->line('vip_status'); ?></th>
					<th><?php echo $this->lang->line('vip_added_time'); ?></th>
					<th><?php echo $this->lang->line('vip_canceled_time'); ?></th>
				</thead>
				<tbody>
	    <?php
	    		$sr_no = 1;
	    		foreach($canceled_user_list_himself as $user):
			?>
				<tr>
					<td><?php echo $sr_no++; ?></td>
					<th><input class='checkbox_for_checking' id="user_row_<?php echo $user['user_id']?>" type='checkbox' name='user_for_gifts_checkbox' data-user-id="<?php echo $user['user_id']?>"></th>
