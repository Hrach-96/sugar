	...
	<form action="" method="post" accept-charset="utf-8" class="general_config well">
	    ...
	    <fieldset>
	        <div class="form-group">
	            ...
	            <input type="text" class="form-control" id="package_name" name="package_name" value="<?php echo set_value("package_name"); ?>">
	        ...
	        <div class="form-group">
				...
				<select name="package_for" id="package_for" class="form-control">
					<option <?php if(set_value("package_for") == 'male'): ?>selected<?php endif; ?> value="male"><?php echo $this->lang->line('male'); ?></option>
					<option <?php if(set_value("package_for") == 'female'): ?>selected<?php endif; ?> value="female"><?php echo $this->lang->line('female'); ?></option>
				</select>
				<?php echo form_error('package_for'); ?>
	        </div>
	        <div class="form-group">
	            <label for="package_validity_total_months"><?php echo $this->lang->line('validity_in_months'); ?> :</label>
	            <input type="text" class="form-control" id="package_validity_total_months" name="package_validity_total_months" value="<?php echo set_value("package_validity_total_months"); ?>" placeholder="e.g. 10">
	        ...
	        <div class="form-group">
	            ...
	            <input type="text" class="form-control" id="package_total_amount" name="package_total_amount" value="<?php echo set_value("package_total_amount"); ?>" placeholder="e.g. 100.00">
	        ...
	        <div class="form-group">
	            ...
	            <input type="text" class="form-control" id="package_total_diamonds" name="package_total_diamonds" value="<?php echo set_value("package_total_diamonds"); ?>" placeholder="e.g. 10">
	        ...
	        <div class="form-group">
				...
				<select name="package_status" id="package_status" class="form-control">
					<option <?php if(set_value("package_status") == 'active'): ?>selected<?php endif; ?> value="active"><?php echo $this->lang->line('active'); ?></option>
					<option <?php if(set_value("package_status") == 'inactive'): ?>selected<?php endif; ?> value="inactive"><?php echo $this->lang->line('inactive'); ?></option>
				</select>
