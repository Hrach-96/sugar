			...
			<tr data-id="<?php echo $approval['photo_id']; ?>">
				...
				<td>
					...
					<a href="<?php echo base_url(); ?>user/profile/view?query=<?php echo urlencode($approval["user_id_encrypted"]); ?>">
						<img style="width:78px;height:78px;border-radius:50%;object-fit:cover;border: 1px solid #464646;" src="<?php echo base_url() . $approval["user_active_photo_thumb"]; ?>?t=<?php echo time(); ?>" />
						<br/>
				...
				<td>
					...
					<img id="profile-image-<?php echo $approval['photo_id']; ?>" style="width:178px;height:178px;object-fit:cover;border: 1px solid #464646;" src="<?php echo base_url() . $approval["photo_url"]; ?>?t=<?php echo time(); ?>" />
          	...
          	canvas.toBlob(function (blob) {
	            ...
	            $.ajax(url, {
	              	...
	              	success: function (data) {
	              		$("#profile-image-" + selected_image_id).attr('src', imgURL + '?t=' + new Date().getTime());
  	              		//location.reload();
