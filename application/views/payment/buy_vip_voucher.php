			...
			if(choosed_version == 'yes'){
				$.ajax({
					...
					success:function(res){
						res = JSON.parse(res);
						if(res != null){
							window.location.replace("<?php echo base_url('user/vip/buyVIP/'.$package_id); ?>?voucher_code=" + voucher_code);
						}
						else{
				...
				window.location.replace("<?php echo base_url('user/vip/buyVIP/'.$package_id); ?>");
			}
		})
	})
</script>
