			...
			<div class="row chat_btns">	
			    <div class="col-md-12">
					<h4 class="full-pay gold-txt">
						<span class="byDiamonds"><?php echo $this->lang->line('kisses'); ?></span>
					</h4>
				</div> 
			</div>            	
			<div class="row">	
				...
				<li class="col-md-6"><a href="<?php echo base_url('kisses?type=received'); ?>" rel="div1" class="showSingle qbtn <?php if($kiss_type == 'received') { echo 'active-tab'; } ?>"><?php echo $this->lang->line('kisses_to_me'); ?></a></li>
				<li class="col-md-6"><a href="<?php echo base_url('kisses?type=sent'); ?>" rel="div1" class="showSingle qbtn <?php if($kiss_type == 'sent') { echo 'active-tab'; } ?>"><?php echo $this->lang->line('kisses_by_me'); ?></a></li>
                </ul>
				</div>
                <div class="question_bx">                	
                    ...
                    <div class="targetDiv" id="div1">
						<div class="kisses_div">	
								<div class="row">
			<?php 
				if($kiss_type == 'received' || ($kiss_type == 'sent' && $this->session->userdata('user_is_vip') == 'yes')) {
					if(!empty($users)) {						
