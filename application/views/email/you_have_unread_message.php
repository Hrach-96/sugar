...
<tr>
	...
	<td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 15px 15px ;vertical-align: top;" align="left">
		<h4 style="text-transform: uppercase;padding: 0px 0px;margin: 0px;font-size: 20px;color: rgb(232, 228, 151);font-family: 'Cinzel', serif;font-weight: 500;"><?php echo $this->lang->line('you_have_received_a_chatmessage_from') . " " . $sender_name . " " . $this->lang->line('erhalten_only_deutch'); ?></h4>

		<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #fff;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo  $this->lang->line('hello').' '.$receiver_name . ", " . $this->lang->line('log_in_because_you_have_received_a_new_chat_message') ?></h4>
		<a href="<?php echo base_url(); ?>/chat" style="width: 353px;height: 51px;background-image: url(<?php echo base_url('images/anmeldenImg.png') ;?>);display: block;line-height: 51px;text-align: center;color: #fff;text-transform: uppercase;letter-spacing: 2px;text-decoration: none;font-family: 'Montserrat', sans-serif;font-size: 16.67px;font-family: 'Montserrat';color: rgb(255, 255, 255);text-transform: uppercase;font-weight: 400;margin-top: 20px;"><?php echo $this->lang->line('watch_chat_now'); ?></a>
	</td>
</tr>
	<tr>
