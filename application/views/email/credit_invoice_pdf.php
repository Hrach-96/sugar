...
<h4 style="padding: 0px 0px;font-size: 16.67px;color: #000;margin: 10px 10px;font-weight: 500;"><?php echo $this->lang->line('date_um') . " " . $buy_credit_date ?></h4>
...
<h4 style="padding: 0px 0px;margin: 0px;font-size: 14.67px;color: #000;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_second_text').' '.$purchased_credits.' '.$this->lang->line('credits_purchased_email_template_third_text'); ?></h4>
<h4 style="padding: 0px 0px;margin: 0px;font-size: 14.67px;color: #000;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_fourth_text'); ?> <?php echo $purchase_currency . " " . $purchase_amount.' '.$this->lang->line('credits_purchased_email_template_fifth_text'); ?></h4>
...
<h4 style="padding: 0px 0px;margin: 0px;font-size: 16.67px;color: #000;margin-top: 15px;font-weight: 400;font-family: 'Montserrat', sans-serif;"><?php echo $this->lang->line('credits_purchased_email_template_sixth_text'); ?></h4>
