...
class Page extends CI_Controller {
    ...
    public function faq() {
        ...
        $data["title"] = $this->lang->line('sugarbabe_deluxe_faq_title');
    ...
    public function blog() {
        redirect(base_url('page/faq'),'location', 302);
    }
    public function get_currency() {
        $select_lang = $this->input->post('select_lang');
        $this->load->model(['Vip_package_model']);
        $vip_multicurrency = $this->Vip_package_model->get_vip_multicurrency($select_lang);
        print json_encode($vip_multicurrency);die;
    }
    public function get_currency_for_credit() {
        $select_lang = $this->input->post('select_lang');
        $this->load->model(['Credit_package_model']);
        $credit_multicurrency = $this->Credit_package_model->get_credit_multicurrency($select_lang);
        print json_encode($credit_multicurrency);die;
    }
    public function contactUs() {
        ...
        $data["captcha_image_url"] = base_url('images/captcha/'.$cap_res['filename']);
        $data["settings"] = $settings;        
        $data["title"] = $this->lang->line('sugarbabe_deluxe_contact_us_title');
    ...
    public function terms_of_use() {
        ...
        $data["title"] = $this->lang->line('sugarbabe_deluxe_terms_of_use_title');
    ...
    public function privacy_statement() {
        ...
        $data["title"] = $this->lang->line('sugarbabe_deluxe_privacy_statement_title');
    ...
    public function imprint() {
        ...
        $this->lang->load(array('user_lang', 'imprint_lang'), $site_language);

        $data["title"] = $this->lang->line('sugarbabe_deluxe_imprint_title');
    ...
    public function cancellation_terms() {
        ...
        $data["title"] = $this->lang->line('sugarbabe_deluxe_cancellation_terms_title');
