...
class Kisses extends CI_Controller {
	...
	public function send_kiss() {
		$this->load->model(['kiss_model', 'user_model', 'email_model', 'photo_model']);
		...
		if($alreadyAdded == true) {
			...
			if($success > 0) {
                ...
                $subject = $this->lang->line('you_got_a_kiss_von') . " " . $this->session->userdata('user_username') . " " . $this->lang->line('erhalten_only_deutch');
