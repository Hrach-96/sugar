...
define('SEARCH_DISTANCE_RANGE', '0,1000');
...
define('DEFAULT_TIMEZONE', 'Europe/Vienna');
define('DEFAULT_COUNTRY', 'Austria');
define('DEFAULT_LANGUAGE', 'german');
define('GOOGLE_MAP_API_KEY', 'AIzaSyBhibFcpcYcQES0bvP4d_0HofWwUnNCNCg');
define('IS_NEW_USER_FOR_DAYS', 30);
...
// Oppwa repeat payment success results, use 000.000.00 for live mode and 000.100.112 for testing mode
define('OPPWA_REPEAT_PAYMENT_SUCCESS_CODE_TEST', '000.100.112');
define('OPPWA_REPEAT_PAYMENT_SUCCESS_CODE_LIVE', '000.000.000');
